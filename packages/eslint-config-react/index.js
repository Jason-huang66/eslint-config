...
if (!TS)
  console.warn('[@Jason-huang66/eslint-config] TypeScript is not installed, fallback to JS only.')
...
module.exports = {
  extends: [
    ...
    TS
      ? '@Jason-huang66/eslint-config-ts'
      : '@Jason-huang66/eslint-config-basic',
  ],
  env: {
    browser: true,
    node: true,
